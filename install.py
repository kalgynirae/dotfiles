...
configs: dict[str, Output] = {
    ...
    ".claude/CLAUDE.md": symlink_to("agents/AGENTS.md"),
    ".claude/coding-guidelines/bash.md": symlink_to("agents/coding-guidelines/bash.md"),
    ".claude/coding-guidelines/comments.md": symlink_to("agents/coding-guidelines/comments.md"),
    ".claude/coding-guidelines/review.md": symlink_to("agents/coding-guidelines/review.md"),
    ...
    ".claude/skills/babysit-stack/SKILL.md": symlink_to("agents/skills/babysit-stack.md"),
    ".claude/skills/handle-pr-feedback/SKILL.md": symlink_to("agents/skills/handle-pr-feedback.md"),
    ".claude/statusline": symlink_to("claude/statusline"),
    ".claude/workflows/jj.md": symlink_to("agents/workflows/jj.md"),
    ".claude/workflows/prs.md": symlink_to("agents/workflows/prs.md"),
    ".claude/workflows/writing.md": symlink_to("agents/workflows/writing.md"),
    ".codex/AGENTS.md": symlink_to("agents/AGENTS.md"),
    ".codex/config.toml": symlink_to("codex/config.toml"),
    ".codex/coding-guidelines/bash.md": symlink_to("agents/coding-guidelines/bash.md"),
    ".codex/coding-guidelines/comments.md": symlink_to("agents/coding-guidelines/comments.md"),
    ".codex/coding-guidelines/review.md": symlink_to("agents/coding-guidelines/review.md"),
    ".codex/skills/babysit-stack/SKILL.md": symlink_to("agents/skills/babysit-stack.md"),
    ".codex/skills/handle-pr-feedback/SKILL.md": symlink_to("agents/skills/handle-pr-feedback.md"),
    ".codex/workflows/jj.md": symlink_to("agents/workflows/jj.md"),
    ".codex/workflows/prs.md": symlink_to("agents/workflows/prs.md"),
    ".codex/workflows/writing.md": symlink_to("agents/workflows/writing.md"),

...
6. If any changes were made in the earlier steps, push the changes using `jfd` (Graphite repos) or `jj git push -c stack` (non-Graphite repos).

7. Exit when: no new unhandled review comments and CI jobs have succeeded on all the PRs.

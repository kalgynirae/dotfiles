...
call s:hi("Comment",        s:brightgrey,     s:none,           "italic")
...
call s:hi("Error",          s:none,           s:darkred,        s:none)
call s:hi("ErrorMsg",       s:red,            s:none,           s:none)
call s:hi("Exception",      s:brightgrey,     s:none,           "bold")
...
call s:hi("Label",          s:brightgrey,     s:none,           "bold")
...
call s:hi("Pmenu",          s:none,           s:black,          s:none)
call s:hi("PmenuSel",       s:none,           s:grey,           "bold")
call s:hi("PmenuSbar",      s:none,           s:darkgrey,       s:none)
call s:hi("PmenuThumb",     s:none,           s:green,          s:none)
...
call s:hi("SpecialComment", s:green,          s:none,           "italic")
...
call s:hi("Tag",            s:blue,           s:none,           "italic")
call s:hi("Title",          s:brightorange,   s:none,           s:none)
call s:hi("Todo",           s:red,            s:none,           "italic")
